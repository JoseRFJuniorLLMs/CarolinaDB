...
**Implementation status (2026-09-13):** Implemented for the LOCAL profile and the single-IDC C5 slice (`crates/carolina-qualify`, `carolina-models` and the campaign modules of storage/consensus/catalog/node): manifest (§2), five-status verdicts and gate derivation, independent W1 oracle, checker Q-C01–05/13/14 with budget-bounded INCONCLUSIVE, crash runner at 13 durable boundaries, Raft simulator, three-process campaign, FM-1/2/3 checkers with negative controls, pinned TLC v1.8.0 runs, four cargo-fuzz harnesses, bundles, minimizer, CLI, QA-01/03/04/05/07/08/10/11; gates Q0/Q1/Q2/FM/Q3-C5 PASS at quick and standard budgets. Missing: Q-C06–12, 20 of 22 Q-F rows, unified SimulationEnvironment, P5, disk-full/page-root injection, retained long fuzz campaigns, W2–W8, baselines/equivalence sheets, performance protocol and E1–E5; QI-SECURITY, Q3, Q4, Q5, Q7 NOT_RUN, Q6 disabled. Table: [docs/AUDIT.md](../docs/AUDIT.md).
**Date:** 2026-09-09
